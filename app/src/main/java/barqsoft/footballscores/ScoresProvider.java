...
public class ScoresProvider extends ContentProvider
{
    ...
    private static final int MATCHES_WITH_DATE_LEAGUE = 104;
    ...
    private static final String SCORES_BY_LEAGUE_DATE = SCORES_BY_LEAGUE +" and "+SCORES_BY_DATE;
    ...
    static UriMatcher buildUriMatcher() {
        ...
        matcher.addURI(authority, "league_date" , MATCHES_WITH_DATE_LEAGUE);
        return matcher;
    }
    ...
    private int match_uri(Uri uri)
    {
        String link = uri.toString();
        {
           ...
           else if(link.contentEquals(DatabaseContract.scores_table.buildScoreWithLeagueAndDate().toString()))
           {
               return MATCHES_WITH_DATE_LEAGUE;
           }
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs)
    {
        ...
        //Log.v(F etchScoreTask.LOG_TAG,String.valueOf(muriMatcher.match(uri)));
        int count = 0;
        switch (match_uri(uri))
        {
            case MATCHES:
                ...
                count =
                        db.update(DatabaseContract.SCORES_TABLE, values,null, null);
                break;
            case MATCHES_WITH_ID:
                count =
                        db.update(DatabaseContract.SCORES_TABLE,values ,SCORES_BY_ID,selectionArgs);
                break;
            default:
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (match)
        {
            ...
            case MATCHES_WITH_DATE_LEAGUE: retCursor = mOpenHelper.getReadableDatabase().query(
                    DatabaseContract.SCORES_TABLE,
                    projection,SCORES_BY_LEAGUE_DATE,selectionArgs,null,null,sortOrder); break;
